...
export default function FencesApp() {
  ...
  const makers  = { 0: makeFencesCh1, 1: makeFencesCh2, 2: makeFencesCh3 };
  ...
  return (
    <div style={{ maxWidth: 440, margin: "0 auto" }}>
      ...
      {/* Narration */}
      {step.narr && <Narration key={`fences-${tab}-${cur}-${lang}`} text={step.narr} />}
